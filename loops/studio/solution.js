...
for (let index = 0; index < numMeals; index++) {
  meal = [];
  meal.push(pantry[0][index]);
  meal.push(pantry[1][index]);
  meal.push(pantry[2][index]);
  meal.push(pantry[3][index]);
  meal.push(pantry[4][index]);
  console.log(meal);
  meals.push(meal); 
}
  return meals;
...
function generatePassword(string1, string2) {
  ...
  for (let index = 0; index < string1.length; index++) {
    code +=string1.substring(index,index+1);
    code += string2.substring(index,index+1);
  }
